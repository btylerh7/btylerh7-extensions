...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaLove = exports.MangaLoveInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const MangaLoveParser_1 = require("./MangaLoveParser");
const ML_DOMAIN = 'https://mangalove.top';
const userAgent = 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.4 Mobile/15E148 Safari/604.1';
exports.MangaLoveInfo = {
    version: '1.0.0',
    name: 'Manga Love',
...
class MangaLove extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        ...
        this.parser = new MangaLoveParser_1.Parser();
    }
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let searchUrl = `${ML_DOMAIN}/?s=${encodeURI((_b = query.title) !== null && _b !== void 0 ? _b : '')}`;
            if (!query.title)
                searchUrl = `${ML_DOMAIN}/category/${encodeURI((_d = (_c = query.includedTags[0]) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : '')}`;
            const request = createRequestObject({
                url: searchUrl,
                method: 'GET',
            });
...
exports.MangaLove = MangaLove;

},{"./MangaLoveParser":49,"paperback-extensions-common":5}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseMangaDetails($, mangaId) {
        ...
        for (let tag of $('.post-category > a').toArray()) {
            const id = (_a = $(tag).attr('href')) === null || _a === void 0 ? void 0 : _a.replace(/https:\/\/mangalove.top\/category\//, '').replace('/', '');
            const label = (_b = $(tag).attr('title')) === null || _b === void 0 ? void 0 : _b.trim();
            if (!id || !label)
                continue;
    ...
    parseChapterDetails($, mangaId, chapterId) {
        ...
        for (let page of $('div.container-chapter-reader').find('img').toArray()) {
            const url = (_a = $(page).attr('data-src')) !== null && _a !== void 0 ? _a : $(page).attr('src');
            if (!url)
                continue;
            pages.push(url);
        }
    ...
    parseResultSet($, id) {
        ...
        for (let result of $(selector).toArray()) {
            const image = (_a = $(result).find('img').attr('data-src')) !== null && _a !== void 0 ? _a : $(result).attr('src');
            const id = (_b = $('a', result).attr('href')) === null || _b === void 0 ? void 0 : _b.replace(/https:\/\/mangalove.top\//, '').replace('/', '');
            const title = (_d = (_c = $('a > h3', result)) === null || _c === void 0 ? void 0 : _c.text().replace('(Raw – Free)', '').trim()) !== null && _d !== void 0 ? _d : '';
            const subtitle = (_e = $('div.relative > a.post-list-duration', result).text().trim()) !== null && _e !== void 0 ? _e : '';
            if (!id)
                continue;
