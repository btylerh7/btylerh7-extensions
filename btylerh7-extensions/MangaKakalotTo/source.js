...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaKakalotTo = exports.MangaKakalotToInfo = exports.MKT_DOMAIN = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const MangaKakalotToParser_1 = require("./MangaKakalotToParser");
exports.MKT_DOMAIN = 'https://mangakakalot.to';
const userAgent = 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.4 Mobile/15E148 Safari/604.1';
exports.MangaKakalotToInfo = {
    version: '0.8.0',
    name: 'MangaKakalotTo',
    description: `Extension that pulls manga from ${exports.MKT_DOMAIN}`,
    author: 'btylerh7',
    authorWebsite: 'http://github.com/btylerh7',
    icon: 'logo.png',
    contentRating: paperback_extensions_common_1.ContentRating.EVERYONE,
    websiteBaseURL: exports.MKT_DOMAIN,
    sourceTags: [
        {
            text: 'Multi-Language',
...
class MangaKakalotTo extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        ...
        this.parser = new MangaKakalotToParser_1.Parser();
    }
    getMangaShareUrl(mangaId) {
        return `${exports.MKT_DOMAIN}/${mangaId}`;
    }
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: `${exports.MKT_DOMAIN}/${mangaId}`,
                method: 'GET'
            });
    ...
    getChapters(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: `${exports.MKT_DOMAIN}/ajax/manga/list-chapter-volume?id=${mangaId.replace(/[a-xA-Z]|-/g, '')}`,
                method: 'GET',
                headers: {
    ...
    getChapterDetails(mangaId, chapterId) {
        return __awaiter(this, void 0, void 0, function* () {
            const numericId = yield this.getNumericId(mangaId, chapterId);
            console.log(numericId);
            const request = createRequestObject({
                url: `${exports.MKT_DOMAIN}/ajax/manga/images?id=${numericId}&type=chap`,
                method: 'GET'
            });
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = createRequestObject({
                url: `${exports.MKT_DOMAIN}/search?keyword=${((_b = query.title) !== null && _b !== void 0 ? _b : '').replace(/ /g, '+')}&page=${page}`,
                method: 'GET',
            });
    ...
    getNumericId(mangaId, chapterId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: `${exports.MKT_DOMAIN}/read/${mangaId}/${chapterId}`,
                method: 'GET'
            });
            const data = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(data.data);
...
exports.MangaKakalotTo = MangaKakalotTo;

},{"./MangaKakalotToParser":58,"paperback-extensions-common":14}],58:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    parseMangaDetails($, mangaId) {
        ...
        const rating = 0;
        const image = (_a = $('.manga-poster', mangaInfoDiv).find('img').attr('src')) !== null && _a !== void 0 ? _a : '';
    ...
    parseChapters($, mangaId) {
        ...
        for (const chapter of $('#list-chapter-en').find('div.item').toArray()) {
            const chapterLink = (_b = (_a = $(chapter).find('a').attr('href')) === null || _a === void 0 ? void 0 : _a.split('/')[4]) === null || _b === void 0 ? void 0 : _b.trim();
            const id = `en/${chapterLink}`;
            const chapNum = (_c = Number(chapterLink === null || chapterLink === void 0 ? void 0 : chapterLink.replace('chapter-', ''.trim()))) !== null && _c !== void 0 ? _c : 0;
    ...
    parseChapterDetails($, mangaId, id) {
        ...
        for (const image of $('.card-wrap').toArray()) {
            const page = (_a = $(image).attr('data-url')) !== null && _a !== void 0 ? _a : $(image).find('img').attr('src');
            if (!page)
                continue;
            pages.push(page);
        }
    ...
    parseSearchResults($) {
        ...
        for (const result of $('.manga-list.is-big-sbs').find('.item').toArray()) {
            const id = (_a = $(result).find('.manga-name a').attr('href')) === null || _a === void 0 ? void 0 : _a.slice(1);
    ...
    parseHomeSections($, sectionCallback) {
        var _a, _b, _c, _d, _e;
        const featuredSection = createHomeSection({ id: 'featured', title: 'Featured Manga', type: paperback_extensions_common_1.HomeSectionType.featured, view_more: false, });
        const popularSection = createHomeSection({ id: 'popular', title: 'Most Popular Manga', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false, });
        const recentlyUpdatedSection = createHomeSection({ id: '2', title: 'Latest Manga Release', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false, });
        const featured = [];
        const popular = [];
        const recentlyUpdated = [];
        for (const featuredManga of $('.swiper-wrapper').find('.item-basic').toArray()) {
            const id = (_a = $(featuredManga).find('.manga-poster').attr('href')) === null || _a === void 0 ? void 0 : _a.slice(1);
            const image = (_b = $(featuredManga).find('img').attr('src')) !== null && _b !== void 0 ? _b : '';
        ...
        for (const popularManga of $('.home-popular-list').find('.item').toArray()) {
            ...
            const id = (_c = $(popularManga).find('a').attr('href')) === null || _c === void 0 ? void 0 : _c.slice(1);
            const image = '';
            if (!id)
                continue;
        ...
        for (const recentlyUpdatedManga of $('#latest-chap').find('.item').toArray()) {
            ...
            const id = (_d = $('.item-info', recentlyUpdatedManga).find('a').first().attr('href')) === null || _d === void 0 ? void 0 : _d.slice(1);
            const image = (_e = $('.item-poster', recentlyUpdatedManga).find('img').attr('src')) !== null && _e !== void 0 ? _e : '';
            if (!id)
                continue;
