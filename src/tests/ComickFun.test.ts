...
import { ComickFun } from '../ComickFun/ComickFun'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('Comick Fun Tests', () => {
    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new ComickFun(cheerio)
    ...
    //23880
    const mangaId = 'jujutsu-kaisen' // jujutsu kaisen
